...
public class Unity3D_TestReporter : TestReporter 
{
     ...
     */
    public override void LogSummary(string _prefix)
    {
        // If the results invalid
        if (null == Result)
        {
            // Log default summary
            Debug.LogWarning(_prefix + "No test results to report, did you add tests to the test suite?");
        }
        else
        {
            // Log summary to console
            Debug.Log(_prefix + Result.GetSummary());
        }
    }
